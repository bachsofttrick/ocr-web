...
llama-cpp-python gets stuck easily, doesn't work as well as sending JSON to OpenAI API of llama.cpp.
That works much better. And this was on Qwen2-VL model.
